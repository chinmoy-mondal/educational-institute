                ...
                <div class="position-relative" style="width:150px; height:200px;">
                    <img class="profile-user-img img-fluid mb-2"
                        src="<?= !empty($user['picture'])
                                                              ...
                                                              : base_url('public/assets/img/default-profile-pic.png'); ?>" alt="Teacher Photo"
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <!-- Right: Edit Button -->
                            <div>
                                <a href="<?= site_url('profile/edit/' . $user['id']) ?>" class="text-primary">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                            </div>

                            <div>
                                <a href="<?= site_url('profile/update-card/' . $user['id']) ?>" class="text-primary"
                                    onclick="return confirm('Are you sure you want to update this card?');">
                                    <i class="fas fa-id-card"></i> Update Card
                                </a>
                            </div>
