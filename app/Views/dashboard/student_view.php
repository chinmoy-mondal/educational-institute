            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="position-relative d-inline-block" style="max-width: 180px;">
                            <a href="<?= site_url('admin/students/edit-photo/' . $student['id']) ?>"
                                class="position-absolute top-0 start-0" title="Edit Photo">
                                <i class="fas fa-edit"></i>
                            </a>
                            <?php if (!empty($student['student_pic'])): ?>
                            <img src="/<?= esc($student['student_pic']) ?>" alt="Student Photo"
                                class="img-thumbnail w-100">
                            <?php else: ?>
                            <img src="<?= base_url('public/assets/img/default.png') ?>" alt="No Photo"
                                class="img-thumbnail w-100">
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p><strong>Class:</strong> <?= esc($student['class']) ?> | <strong>Section:</strong>
                                    <?= esc($student['section']) ?> | <strong>4th Subject:</strong>
                                    <?= esc($forthSubject) ?></p>
                                <p><strong>Board ID:</strong> <?= esc($student['esif']) ?></p>
                                <p><strong>Phone:</strong> <?= esc($student['phone']) ?></p>
                                <p><strong>Gender:</strong> <?= esc($student['gender']) ?> | <strong>DOB:</strong>
                                    <?= esc($student['dob']) ?></p>
                                <p><strong>Religion:</strong> <?= esc($student['religion']) ?> | <strong>Blood
                                        Group:</strong> <?= esc($student['blood_group']) ?></p>
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="<?= site_url('admin/students/forth/' . $student['id']) ?>" method="post">
                                    ...
                                    <select class="form-select w-100" id="subjectSelect" name="selectid" size="10">
                                        ...
                                        <option value="<?= esc($subject['id']) ?>"><?= esc($subject['subject']) ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <input type="hidden" id="subject_id_input" name="subject_id"
                                        value="<?= esc($subjectsStr) ?>">
                                    <input type="hidden" id="subject_id_input" name="subject_class"
                                        value="<?= esc($student['class']) ?>">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <p><strong>Phone:</strong> <?= esc($student['father_nid_number']) ?></p>
                    </div>
                    <div class="col-md-6">
                        <h5>Mother's Information</h5>
                        <p><strong>Name:</strong> <?= esc($student['mother_name']) ?></p>
                        <p><strong>Phone:</strong> <?= esc($student['mother_nid_number']) ?></p>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <p><small><strong>Created:</strong> <?= esc($student['created_at']) ?> | <strong>Updated:</strong>
                            <?= esc($student['updated_at']) ?></small></p>
                </div>
