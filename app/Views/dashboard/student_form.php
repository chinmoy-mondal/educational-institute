        ...
        <div class="col-md-11">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/student/save') ?>" method="post" enctype="multipart/form-data" class="row g-3">
                        <?= csrf_field() ?>
                        ...
                        <div class="col-12 text-center">
                            ...
                            <a href="<?= base_url('admin/student/list') ?>" class="btn btn-secondary">View Students</a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    function toggleSectionField() {
        ...
        sectionContainer.style.display = (selectedClass === '9' || selectedClass === '10') ? 'block' : 'none';
    }
