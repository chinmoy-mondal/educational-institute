                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  ...
                                  ? $user['picture']
                                  : base_url('public/assets/img/default.png') ?>" width="50" height="50"
                                ...
                                <td>
                                    ...
                                    <i class="fas fa-id-card" title="RFID: <?= esc($user['rfid']) ?>"
                                ...
                                <td class="text-center">
                                    <form action="<?= base_url('admin/updatePosition/' . esc($user['id'])) ?>"
                                        method="post" class="d-flex align-items-center">
                                        <select name="position" id="position" class="form-control me-1"
                                            style="width:auto; min-width:70px;" required>
                                ...
                                <td class="text-center">
                                    <!-- Profile Button -->
                                    <a href="<?= site_url('profile_id/' . $user['id']) ?>" class="btn btn-sm btn-info"
                                        title="View Profile">
