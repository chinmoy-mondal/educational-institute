			...
			<div class="card-body">
				<form method="get" action="<?= site_url('admin/student') ?>">
					<div class="row align-items-end">
						<div class="col-md-2">
							<label>Search</label>
							<input type="text" name="q" class="form-control" value="<?= esc($q ?? '') ?>" placeholder="Name, Roll, ID">
						</div>
						...
						<div class="col-md-2">
							...
							<select name="religion" class="form-control">
								<option value="">All</option>
								<option value="__NULL__" <?= ($religion ?? '') === '__NULL__' ? 'selected' : '' ?>>Not Set</option>
						...
						<div class="col-md-2">
							...
							<select name="gender" class="form-control">
								<option value="">All</option>
								<option value="__NULL__" <?= ($gender ?? '') === '__NULL__' ? 'selected' : '' ?>>Not Set</option>
