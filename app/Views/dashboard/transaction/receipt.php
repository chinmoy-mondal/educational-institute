...
<style>
    ...
    .receipt {
        width: 95%;
        /* slightly smaller than full width for margin */
        height: 48%;
        /* half of A4 page minus small spacing */
        background: #fffdeb;
        ...
        margin-bottom: 4%;
        /* space between top and bottom receipt */
    }
    ...
    <?php for ($copy = 0; $copy < 2; $copy++): ?>
        <div class="receipt">
            ...
            <div class="header">
                ...
                <div class="school-sub">Address: <?= esc($schoolAddress) ?> | Phone: <?= esc($schoolPhone) ?></div>
