    ...
    <form method="post" action="<?= site_url('admin/attendance/calendar') ?>"
        ...
        <div class="form-group mb-0 me-2">
            <select name="section" id="section" class="form-select form-select-sm" style="height: 34px;">
                ...
                <option value="Vocational" <?= ($selectedSection ?? '') === 'Vocational' ? 'selected' : '' ?>>Vocational
                </option>
            </select>
        </div>
        ...
        <div class="form-group mb-0 me-2" style="margin-right: 12px;">
            <input type="date" name="date" id="date" value="<?= $selectedDate ?? '' ?>"
                class="form-control form-control-sm" style="height: 34px;">
        </div>
        ...
        <div class="form-group mb-0 me-2" style="margin-right: 12px;">
            <button type="button" class="btn btn-danger btn-sm" style="height: 34px;" onclick="setAllAttendance('A')">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <input type="hidden" name="attendance[<?= $s['id'] ?>][<?= $selectedDate ?>]"
                            value="<?= $remark ?>">
                    </td>
                </tr>
                <?php endforeach; ?>
