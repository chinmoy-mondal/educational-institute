...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventContent: function(arg) {
            ...
            let details = [category, subcategory, eventClass]
                .filter(Boolean)
                .join(' • ');

            const detailEl = document.createElement('div');
            detailEl.innerHTML =
                `<small style="font-size:11px;opacity:0.9;">${details}</small>`;
        ...
        eventClick: function(info) {
            ...
            "";
            document.getElementById("modal-subcategory").innerText = event.extendedProps
                .subcategory || "";
