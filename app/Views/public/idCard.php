...
<div class="container py-5">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-4">
        ...
        <!-- FRONT -->
        <div id="card-front" class="id-card"
            style="background-image: url('<?= base_url("public/assets/img/bg-front.png") ?>');">
            <!-- Logo -->
            ...
            <div class="text-center text-black mb-1">
                ...
                <p class="mb-0"><i class="fas fa-phone me-2"></i><?= esc($student['class']) ?></p>
        ...
        <!-- BACK -->
        <div id="card-back" class="id-card"
	  ...
	  <div class=" mb-1">
            ...
            <div class="mb-1">
                <i class="fas fa-globe me-2"></i> www.jpscac.com
            </div>
        </div>
        <br>
...
<div class="text-center mt-4">
    <button class="btn btn-primary me-3"
        onclick="downloadCard('card-front', 'front_<?= $student['id'] ?>.jpg')">Download Front</button>
    <button class="btn btn-secondary" onclick="downloadCard('card-back', 'back_<?= $student['id'] ?>.jpg')">Download
        Back</button>
</div>
</div>
