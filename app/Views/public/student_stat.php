...
Object.keys(stats).forEach(cls => {
    ...
    new Chart(document.getElementById("genderChart"+cls), {
        ...
        options: { responsive: true, plugins: { legend: { display: false }, title: { display: true, text: 'Gender' } } }
    });
    ...
    new Chart(document.getElementById("religionChart"+cls), {
        ...
        options: { responsive: true, plugins: { title: { display: true, text: 'Religion' } } }
    });
    ...
    new Chart(document.getElementById("bloodChart"+cls), {
        ...
        options: { responsive: true, plugins: { title: { display: true, text: 'Blood Group' } } }
    });
});
</script>
