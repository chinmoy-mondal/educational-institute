    ...
    <div class="page">
        ...
        <div class="admit-card">
            ...
            <table style="width:100%; text-align:center; margin-bottom: 5px;">
                <tr>
                    <td style="width:80px;">
                        <img src="<?= base_url('public/assets/img/logo.jpg') ?>" style="width:70px; height:70px;"
                            alt="Logo">
                    </td>
                    <td>
                    ...
                    <td style="width:80px;">
                        <img src="<?= base_url(esc($student['student_pic'])) ?>" width="65" height="75"
                            alt="Student Photo">
                    </td>
                </tr>
            </table>
            ...
            <table class="routine-table">
                ...
                <tr>
                    ...
                    <td><?= date('h:i A', strtotime($routine['start_time'])) ?> -
                        <?= date('h:i A', strtotime($routine['end_time'])) ?></td>
