                                ...
                                <?php foreach ($allDates as $date): ?>
                                    ...
                                    if (isset($attendances[$date][$studentId])) {
                                        ...
                                        if ($in <= '10:00:00' && $out >= '16:00:00') {
                                            ...
                                            $status = '<span class="badge bg-warning text-dark" title="Late">A</span>';
                                        } elseif ($in <= '10:00:00' && $out < '16:00:00') {
                                            $status = '<span class="badge bg-info text-dark" title="Early Out">A</span>';
                                        } elseif ($in > '10:00:00' && $out < '16:00:00') {
                                            $status = '<span class="badge bg-danger" title="Late & Early Out">A</span>';
                                        } else {
                                            $status = '<span class="badge bg-secondary" title="Absent">A</span>';
                                        }
