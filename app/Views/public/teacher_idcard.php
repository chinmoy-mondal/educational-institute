...
<div class="container py-5">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-4">
	  ...
	  <div class=" mb-1">
        ...
        <div class="text-center small text-white mt-1"><?= esc($user['address']) ?></div>
    </div>
</div>

<!-- Download Buttons -->
<div class="text-center mt-4">
    <button class="btn btn-primary me-3" onclick="downloadCard('card-front', 'front_<?= $user['id'] ?>.jpg')">Download
        Front</button>
    <button class="btn btn-secondary" onclick="downloadCard('card-back', 'back_<?= $user['id'] ?>.jpg')">Download
        Back</button>
</div>
</div>
