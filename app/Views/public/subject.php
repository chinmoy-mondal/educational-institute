...
<div class="container content">
    <section class="py-5">
        <div class="container">
            ...
            // Sort by numeric class first, then section
            uksort($grouped, function ($a, $b) {
                [$classA, $sectionA] = explode('|', $a);
                [$classB, $sectionB] = explode('|', $b);

                // Compare class numerically
                if ((int)$classA !== (int)$classB) {
                    return (int)$classA <=> (int)$classB;
                }

                // If class same, compare section alphabetically
